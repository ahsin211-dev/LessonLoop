/**
 * Research-Based Instructional Strategies (RBIS) knowledge base.
 * Production uses OpenSearch index; local dev uses this static map.
 */
...
module.exports = { RBIS_STRATEGIES };
